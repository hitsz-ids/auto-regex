from auto_regex.regex_tree.function_set import TernaryOperator
from auto_regex.regex_tree.terminal_set import Constant, Anchor
...
class MatchMinMax(TernaryOperator):
    ...
    def is_valid(self):
        from auto_regex.regex_tree.function_set import Concatenator,\
    ...
    def form(self, string, flavour=RegexFlavour.Python, context=RegexContext()):
        from auto_regex.regex_tree.function_set import Group, NonCapturingGroup
