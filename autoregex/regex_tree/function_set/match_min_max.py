from autoregex.regex_tree.function_set import TernaryOperator
from autoregex.regex_tree.terminal_set import Constant, Anchor
...
class MatchMinMax(TernaryOperator):
    ...
    def is_valid(self):
        from autoregex.regex_tree.function_set import Concatenator,\
    ...
    def form(self, string, flavour=RegexFlavour.Python, context=RegexContext()):
        from autoregex.regex_tree.function_set import Group, NonCapturingGroup
