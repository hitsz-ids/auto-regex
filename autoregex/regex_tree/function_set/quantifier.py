...
from autoregex.regex_tree.function_set import UnaryOperator
from autoregex.regex_tree.terminal_set import Anchor


class Quantifier(UnaryOperator):
    def is_valid(self):
        # 不能放在外面，不然有循环引用
        from autoregex.regex_tree.function_set import MatchMinMax, MatchMinMaxGreedy, Lookaround
